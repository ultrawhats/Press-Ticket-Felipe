      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            ...
            {i18n.t("mainDrawer.appBar.message.hi")} <b>{user.name}</b>, {i18n.t("mainDrawer.appBar.message.text")} <b>{system.name || "ultraWhats"}</b>
          </span>
          ...
          <div>
            ...
            >
              ...
              <span className={classes.systemCss}>
                <Link color="inherit" href={"https://ultrawhats.com.br"}>
                  v{systemVersion}
                </Link>
              </span>
            </Menu>
